...
@section('header')
    <h4 class="m-0">Buat Renja Baru</h4>
@endsection
@push('css')
    <link rel="stylesheet"
...
@section('content')
    <div class="container clearfix">
        <div class="form-widget">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <form class="row" action="{{route('renja.store')}}" method="post"
                        ...
                        <div class="col-12 form-group">
                            <label>Nama Renja:</label>
                            <input type="text" name="renja" id="freelance-quote-name"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="input-group nk-int-st">
                                    <select class="form-control select2" id="kec_id" name="kec_id" required disabled>
