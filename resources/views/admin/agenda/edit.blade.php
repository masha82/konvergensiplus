...
@section('content')
    <div class="container clearfix">
        <div class="form-widget">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <form class="row" action="{{route('agenda.update', $data->id)}}" method="post"
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input type="text" name="nama_agenda" id="freelance-quote-name" value="{{$data->nama_agenda}}"
                                   class="form-control" required>
                        </div>
                        <div class="col-12 form-group">
                            <label>Sasaran:</label>
                            <input type="text" name="sasaran" value="{{$data->sasaran}}"
                                   class="form-control" required>
                        </div>
                        <div class="col-12 form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group date" id="timepicker" data-target-input="nearest">
                                    <input type="text" name="tgl_mulai" class="form-control datetimepicker-input" value="{{$data->tgl_mulai}}"
                                           id="tanggal_mulai">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group date" id="timepicker" data-target-input="nearest">
                                    <input name="tgl_selesai" type="text" class="form-control datetimepicker-input" value="{{$data->tgl_selesai}}"
                                           id="tanggal_selesai">
