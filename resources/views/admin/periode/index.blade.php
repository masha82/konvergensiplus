        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('periode.create')}}" class="btn btn-info float-right">Buat Baru</a>
                </div>
                <!-- /.card-header -->
    ...
    <script>
        $(document).ready(function () {
            var dt = $('#posts').DataTable({
                ...
                columns: [
                    {
                        data: 'tahun', name: 'tahun', visible: false, searchable: false
                    },
                    {
                        data: 'bulan', name: 'bulan', visible: false
                    },
                    {data: 'nama_bulan', name: 'nama_bulan', searchable: false, orderable: false},
